...
assignments.append(assignment(parameters.get(type1), parameters.get(subject1), parameters.get(date1)))
assignments.append(assignment(parameters.get(type2), parameters.get(subject2), parameters.get(date2)))
assignments.append(assignment(parameters.get(type3), parameters.get(subject3), parameters.get(date3)))
assignments.append(assignment(parameters.get(type4), parameters.get(subject4), parameters.get(date4))) 
